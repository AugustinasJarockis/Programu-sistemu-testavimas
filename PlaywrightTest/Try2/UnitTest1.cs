    ...
    public class UnitTest1
    {
        ...
        public async Task Test2() {
            ...
            for (int i = 0; i < 8; i++) {
                ...
                await page.GetByRole(AriaRole.Textbox, new() { Name = "Last Name" }).FillAsync("Jonas");
                await page.Locator("#age-wrapper").ClickAsync();
                await page.GetByRole(AriaRole.Textbox, new() { Name = "name@example.com" }).DblClickAsync();
                await page.GetByRole(AriaRole.Textbox, new() { Name = "name@example.com" }).FillAsync("petras@gmail.com");
                await page.GetByRole(AriaRole.Textbox, new() { Name = "Age" }).ClickAsync();
                await page.GetByRole(AriaRole.Textbox, new() { Name = "Age" }).FillAsync("20");
