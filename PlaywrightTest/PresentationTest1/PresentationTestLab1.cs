...
{
    public class PresentationTestLab1
    {
        [Fact]
        public async Task Test() {
            ...
            await page.GetByRole(AriaRole.Link, new() { Name = "$100 Physical Gift Card", Exact = true }).ClickAsync();
            await page.GetByRole(AriaRole.Textbox, new() { Name = "Recipient's Name:" }).ClickAsync();
            await page.GetByRole(AriaRole.Textbox, new() { Name = "Recipient's Name:" }).FillAsync("jonas");
            await page.GetByRole(AriaRole.Textbox, new() { Name = "Your Name:" }).ClickAsync();
            await page.GetByRole(AriaRole.Textbox, new() { Name = "Your Name:" }).FillAsync("petras");
            await page.GetByText("Qty: Add to cart Add to").ClickAsync();
            await page.GetByRole(AriaRole.Textbox, new() { Name = "Qty:" }).ClickAsync();
            ...
            await page.Locator("#product_attribute_71_10_16").ClickAsync();
