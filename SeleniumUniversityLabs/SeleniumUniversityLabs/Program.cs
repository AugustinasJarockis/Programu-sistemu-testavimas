...
var selectedGiftCard = driver.FindElement(By.XPath("//div[@class='product-item']/div[@class='details' and ./div[@class='add-info']/div[@class='prices']/span/text() > 99.00]/h2/a"));
...
if (subtotalAmount.Text == "1002600.00") {
    Console.WriteLine("Testas atliktas teisingai!");
}
else {
    Console.WriteLine("Testo rezultatas neteisingas! Suma turėjo būti 1002600.00, o yra " + subtotalAmount.Text);
}
